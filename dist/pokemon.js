...
exports.pokemons = {
    ...
    results: [
        ...
        },
        {
            ...
            description: "Its rounded shape and the grooves on its surface minimize resistance in water, enabling SQUIRTLE to swim at high speeds. It shelters itself in its shell, then strikes back with spouts of water at every opportunity. The shell is soft when it is born. It soon becomes so resilient, prodding fingers will bounce off it.",
            card: "https://m.media-amazon.com/images/I/71AicEWk68L._AC_SL1500_.jpg",
        },
        {
            id: 5,
            name: "Bulbasaur",
            image: "https://render.fineartamerica.com/images/rendered/default/print/8/5.5/break/images/artworkimages/medium/1/bulbasaur-bulb.jpg",
            description: "Bulbasaur are small, squat amphibian and plant Pokémon that move on all four legs, and have blue-green bodies with darker blue-green spots. As a Bulbasaur undergoes evolution into Ivysaur and then later into Venusaur, the bulb on its back blossoms into a large flower.",
